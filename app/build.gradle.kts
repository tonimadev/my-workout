...
dependencies {
    ...
    implementation(project(":features:history:bridge"))
    ...
    implementation(project(":features:stats:bridge"))
    implementation(project(":features:stats:impl"))
    implementation(project(":features:workout:bridge"))
    implementation(project(":features:workout:impl"))
