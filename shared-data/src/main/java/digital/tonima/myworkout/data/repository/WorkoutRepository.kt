...
interface WorkoutRepository {
    ...
    suspend fun addWorkout(workout: WorkoutEntity, exercises: List<ExerciseWithSets>)
...
class WorkoutRepositoryImpl @Inject constructor(
    ...
    override fun getAllWorkouts(): Flow<List<WorkoutWithExercises>> =
        workoutDao.getAllWorkoutsWithExercises()

    override fun getWorkoutById(id: Long): Flow<WorkoutWithExercises?> =
    ...
    override fun getAllSessions(): Flow<List<SessionWithLogs>> =
        workoutSessionDao.getAllSessionsWithLogs()

    override fun getSessionById(id: Long): Flow<SessionWithLogs?> =
        workoutSessionDao.getSessionWithLogs(id)
